"""
=============================================================
  층간소음 ANC 프로젝트 - 센서 & 입력 담당 (Raspberry Pi)
  파일명: sensor_input.py
  설명: I2S 마이크 세팅, 진동 센서 튜닝, 노이즈 데이터 수집,
        입력 신호 안정화 통합 모듈
=============================================================
  [사전 설치]
  pip install sounddevice numpy pyserial scipy
...
def process(self, raw_signal):
    ...
    # signal = self.normalize(signal)  ← 이거 주석처리
    # DSP팀이 직접 정규화하면 여기선 생략 가능
    return signal
