/*
  ...
  상쇄간섭 업그레이드용 ESP32 코드입니다.

  ESP32 역할:
  1. INMP441 마이크로 소리를 듣습니다.
  2. 마이크 데이터를 WebSocket으로 Raspberry Pi에 보냅니다.
  3. Raspberry Pi가 계산한 반대 위상 상쇄 신호를 다시 받습니다.
  4. 받은 상쇄 신호를 GPIO25 DAC로 출력합니다.
  5. PAM8403 앰프와 스피커가 상쇄 소리를 출력합니다.

  구조:
  INMP441 -> ESP32 -> WebSocket -> Raspberry Pi -> WebSocket -> ESP32 -> GPIO25 DAC -> PAM8403 -> Speaker
...
void setup() {
  ...
  Serial.println("ESP32 WebSocket Destructive Interference Prototype");
